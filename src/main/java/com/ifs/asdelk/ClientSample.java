...
public class ClientSample {
    ...
    public static void main(String[] params) throws Exception {
        ClientSample app = new ClientSample();
        app.perform("http://localhost:8080/odata-server-sample/cars.svc");
    }
...
//        }
        ...
        print("\n----- Read Entry ------------------------------");
        ClientEntity entry = readEntityWithKey(edm, serviceUrl, "Cars", 1);

//        print("Single Entry:\n" + prettyPrint(entry.getProperties(), 0));

        Car car = ODataEntityMapper.readFromClient(entry, Car.class);
        print(car.toString());
...
//        ClientEntity ce = loadEntity("/mymanufacturer.json");
        ClientEntity newEntity = this.client.getObjectFactory().newEntity(new FullQualifiedName("olingo.odata.sample", "Car"));
        Car eg8 = new Car(1728, "Civic EG8", "1995", 15.00, "LKR");
        EdmEntityType edmEntityType = edm.getEntityType(new FullQualifiedName("olingo.odata.sample","Car"));
        ODataEntityMapper.writeToClient(this.client,edmEntityType, newEntity, eg8, false);
        entry = createEntity(edm, serviceUrl, "Cars", newEntity);
//
//        print("\n----- Update Entry ------------------------------");
